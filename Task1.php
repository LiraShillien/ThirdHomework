...
$parse = parse_url($url);
$myTld = [];
$parse['sld'] = getSld($url, $myTld);
$parse['tld'] = getTld($myTld);
...
function getSld($url, &$myTld)
{
   $tld = [".aero",".biz",".cat",".com",".coop",".edu",".gov",".info",".int",".jobs",".mil",".mobi",".museum",
...
".cc",".cd",".cf",".cg",".ch",".ci",".ck",".cl",".cm",".cn",".cr",".cs",".cu",".cv",".cx",".cy",".cz",".de",".dj",".dk",".dm",
